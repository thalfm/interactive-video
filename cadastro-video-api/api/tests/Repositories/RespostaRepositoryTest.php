...
class RespostaRepositoryTest extends TestCase
{
    ...
    public function test_create_resposta()
    {
        ...
        $this->assertArrayHasKey('id', $createdResposta);
        $this->assertNotNull($createdResposta['id'], 'Created Resposta must have id specified');
        $this->assertNotNull(Resposta::find($createdResposta['id']), 'Resposta with given id must be in DB');
    ...
    public function test_read_resposta()
    {
        ...
        $dbResposta = $this->respostaRepo->find($resposta->id);
    ...
    public function test_update_resposta()
    {
        ...
        $updatedResposta = $this->respostaRepo->update($fakeResposta, $resposta->id);
    ...
    public function test_delete_resposta()
    {
        ...
        $resp = $this->respostaRepo->delete($resposta->id);

        $this->assertTrue($resp);
        $this->assertNull(Resposta::find($resposta->id), 'Resposta should not exist in DB');
    }
}
